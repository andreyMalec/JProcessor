...
public class TestJProcessor {
    @Test
    public void testTestClassConstructor() {
    ...
    public void testCatConstructor() {
        //        Cat cat = CatConstructor.byDefault(5, "ded");
        //
        //        assertEquals(5, cat.age);
        //        assertEquals(2.2, cat.weight, 0.1);
        //
        //        assertEquals("ded", cat.name);
